...
class orderdupmodel extends CI_Model{
	...
	//else{
		...
		$query = $this->db->select('*')
                        ->from('site_operators')
                        ->join('contract_header', 'contract_header.SiteName= site_operators.SiteName')
						->like('contract_header.SiteName', $filter, 'after')
						->group_by('site_operators.SiteName')
                        ->get('', $limit, $offset); 
