...
<body>
  <div id="container">
        ...
        <h5>Generate by Contract Number</h5>
		</center>
	...
	<div class="row">
       ...
       <fieldset>
		...
		<form name='search' action=<?=site_url('legacysetcontractno/search');?> method='post'>
        <center>
        <H4><?php echo $title1; ?>
        </H4>
        </center>
           ...
           <table>	
	 	   <tr><td><td> </tr>
           <tr>
           <td>(2) <input name="cn" type='text' id="cn" placeholder="Enter Contract Number"  /> </td>     
