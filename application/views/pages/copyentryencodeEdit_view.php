 ...
 <!-- Page Content -->
		...
		<table width="350px">
         ...
         Start Week
          ...
          <input type="text" name="StartWeek" id="StartWeek" style=" font-weight:bolder" placeholder="Choose Date"    class="text" value="<?php echo (isset($Users['StartDate']))?$Users['StartDate']:''; ?>"/>
         ...
         End Week
          ...
          <input type="text" name="EndWeek" id="EndWeek" style=" font-weight:bolder"  placeholder="Choose Date"   class="text" value="<?php echo (isset($Users['EndDate']))?$Users['EndDate']:''; ?>"/>
        ...
        ?>     
         ...
         Spot Name(s)
          ...
          <input type="text" name="SpotName"style=" font-weight:bolder" id="Spotname" class="Spotname"    value="<?php echo (isset($Users['SpotName']))?$Users['SpotName']:''; ?>"/>
    ...
    &nbsp;&nbsp;&nbsp;
         ...
         <?php $site_network_name = $this->copyentryencodemodel->get_site_network($mysiteoperator);?> 
			...
			<?php echo form_dropdown('NetworkName', $site_network_name,$value_network_name,'class="NetworkName" id="NetworkName" style="visibility:show" '); ?>  
         ...
         <td>
          ...
          <td>
           <input type="submit" class="btn btn-primary btn-lg active" value="Update" />
          </td>
