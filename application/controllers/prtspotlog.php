...
class Prtspotlog extends CI_Controller{	
	...
	#load library dan helper yang dibutuhkan
		...
		$this->load->library(array('table','form_validation'));
	 	...
	 	$this->load->model('prtspotlogmodel','',TRUE);
 		$this->is_logged_in();
 	}
	...
	$Users->siN,
	//Distribution Column
	$this->prtspotlogmodel->get_syscode($Users->chS),
	//No of order Column
	$this->prtspotlogmodel->get_progname($Users->siN),
	SUBSTR($Users->siT,11),
