...
class BillingSetUpdate extends CI_Controller
{
	private $limit = 12;
	...
	$config['base_url'] = site_url('/BillingSetUpdate/index');
	...
	anchor(array('BillingSetUpdate/update/'.$user1,$Users->Year,$Users->Month,$Users->Start_Date, $Users->End_Date),'Select',array('class'=>'update')));
	...
	$data['Role']=$this->session->userdata('role');
		...
		$this->load->view('pages/BillingSetUpdate_view', $data);
...
function update($id,$year,$month, $sd, $ed){
	...
	// set validation properties
	 	$this->_set_rules();
	 	$data['action'] = ('BillingSetUpdate/update/'.$id."/".$year."/".$month."/".$sd."/".$ed);
